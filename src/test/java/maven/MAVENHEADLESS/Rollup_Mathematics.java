...
public class Rollup_Mathematics {
	...
	String u = "https://www.pearsonschool.com/index.cfm?locator=PSZu6e";
	  ...
	  public void acorn1() {
		  Cookie name = new Cookie("LB", "acorn1");
			...
			driver.get(u);
			 Assert.assertEquals(driver.getTitle(), "Math Programs | Pearson | K-12 Mathematics Curriculums");
	  ...
	  public void afterMethod(ITestResult result) {
		  ...
		  Set<Cookie> cookiesList =  driver.manage().getCookies();
			for(Cookie getcookies :cookiesList) {
			    ...
			    System.out.print(getcookies.getName() +"  "+ getcookies.getValue() + " Math ");
				}else {}
			}
