...
public class PS1gWt {
	WebDriver driver;
	String u = "https://www.pearsonschool.com/index.cfm?locator=PS1gWt";
	  ...
	  public void acorn1() {
		  Cookie name = new Cookie("LB", "acorn1");
			...
			driver.get(u);
			Assert.assertEquals(driver.getTitle(), "Access Codes - SS - Pearson School");
	  ...
	  public void afterMethod(ITestResult result) {
		  ...
		  Set<Cookie> cookiesList =  driver.manage().getCookies();
			for(Cookie getcookies :cookiesList) {
			    ...
			    System.out.print(getcookies.getName() +"  "+ getcookies.getValue() + " PS1gWt ");
				}else {}
			}
