...
public class PSZj4a {
	WebDriver driver;
	String u = "https://www.pearsonschool.com/index.cfm?locator=PSZj4a";
	  ...
	  public void acorn1() {
		  Cookie name = new Cookie("LB", "acorn1");
			...
			driver.get(u);
			Assert.assertEquals(driver.getTitle(), "Access - Pearson School");
	  ...
	  public void afterMethod(ITestResult result) {
		  ...
		  Set<Cookie> cookiesList =  driver.manage().getCookies();
			for(Cookie getcookies :cookiesList) {
			    ...
			    System.out.print(getcookies.getName() +"  "+ getcookies.getValue() + " PSZj4a ");
				}else {}
			}
